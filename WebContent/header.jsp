...
<body style="background-color: gray;">
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #131842; color: white; padding: 5px;">
		<h2>SmartView Store</h2>
		...
		<p align="center"
			style="color: #DEF9C4; font-weight: bold; margin-top: 5px; margin-bottom: 5px;"
			id="message"></p>
	</div>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="adminViewProduct.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Admin Home</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">Product Menu<span
							class="caret"></span>
					</a>
