		...
		<div class="row"
			...
			<form action="./AddProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: #E68369;">Product Addition Form</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Enter Product Name</label> <input type="text"
							placeholder="Enter Product Name" name="name" class="form-control"
							id="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="producttype">Select Product Type</label> <select name="type"
				...
				<div class="form-group">
					<label for="last_name">Enter Product Description</label>
					<textarea name="info" class="form-control" id="last_name" required></textarea>
				</div>
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Enter Unit Price</label> <input type="number"
							placeholder="Enter Unit Price" name="price" class="form-control"
							id="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="last_name">Enter Stock Quantity</label> <input type="number"
				...
				<div>
					<div class="col-md-12 form-group">
						<label for="last_name">Place Product Image</label> <input type="file"
				...
				<div class="row">
					...
					<div class="col-md-6 text-center">
						<button type="submit" class="btn btn-primary" style="width:80%">Add Product</button>
					</div>
				</div>
			</form>
		</div>
