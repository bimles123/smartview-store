...
<body style="background-color: #ebf0f9;">
	...
	<div class="text-center"
		style="color: #000; font-size: 24px; font-weight: bold; margin: 20px 0px">Cart
		Items</div>
 ...
 -->
	...
	<div class="container">
		...
		<table class="table table-hover">
			<thead
				style="background-color: #000; color: white; font-size: 16px; font-weight: bold;">
				<tr>
					<th>Picture</th>
					<th>Products</th>
					<th>Price</th>
			...
			<tbody
				...
				<tr>
					...
					<td><form method="post" action="./UpdateToCart">
							<input type="number" name="pqty" value="<%=prodQuantity%>"
								...
								style="max-width: 80px; background-color: #9CDBA6; border: none;">
						</form></td>
					<td><a
				...
				<tr style="background-color: #9CDBA6; color: white;">
				...
				if (totAmount != 0) {
				%>
				<tr style="background-color: #50B498; color: white;">
					<td colspan="4" style="text-align: center;">
					<td><form method="post">
							<button formaction="userHome.jsp"
								style="background-color: black; color: white; border: none; width: 150px;">Cancel</button>
						</form></td>
					<td colspan="2" align="center"><form method="post">
							<button style="background-color: #FFB200; color: white; border: none; width: 150px;" 
