			...
			<form action="./UpdateProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						...
						<h2 style="color: #E68369;">Product Update Form</h2>
					</div>
				...
				<div class="row text-center">
					<div class="col-md-4" style="margin-bottom: 2px;">
						<button formaction="adminViewProduct.jsp" class="btn btn-danger" style="width: 80%;">Cancel</button>
					</div>
					<div class="col-md-4">
						<button type="submit" class="btn btn-success" style="width: 80%;">Update
							Product</button>
					</div>
				</div>
			</form>
