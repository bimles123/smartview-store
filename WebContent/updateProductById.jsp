		...
		<div class="row"
			...
			<form action="updateProduct.jsp" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h3 style="color: #E68369;">Product Update Form</h3>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					<div class="col-md-6 text-center" style="margin-bottom: 2px;">
						<a href="adminViewProduct.jsp" class="btn btn-info" style="width: 80%;">Cancel</a>
					</div>
					<div class="col-md-6 text-center">
						<button type="submit" class="btn btn-danger" style="width: 80%;">Update
							Product</button>
					</div>
				</div>
			</form>
